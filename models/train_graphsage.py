"""Train a GraphSAGE model on the Elliptic dataset."""
import argparse
import sys, pathlib
...
def main():  # pragma: no cover
    parser = argparse.ArgumentParser(description="Train GraphSAGE on Elliptic")
    ...
    if args.save:
        ckpt_path = (CHECKPOINT_DIR / "graphsage_elliptic.pt").as_posix()
